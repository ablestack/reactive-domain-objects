import { DetailedError, federationSpec, isComplexPluginOutput } from '@graphql-codegen/plugin-helpers';
import { buildASTSchema, parse, Kind, visit, print } from 'graphql';
...
function validateDuplicateDocuments(files) {
    ...
    files.forEach(file => {
        ...
        file.document.definitions = [...deduplicatedDefinitions];
    });
