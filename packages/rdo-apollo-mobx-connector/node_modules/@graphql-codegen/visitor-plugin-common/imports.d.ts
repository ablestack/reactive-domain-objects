export declare type ImportDecleration<T = string> = {
    outputPath: string;
...
export declare function generateFragmentImportStatement(statement: ImportDecleration<FragmentImport>, kind: 'type' | 'document' | 'both'): string;
export declare function generateImportStatement(statement: ImportDecleration): string;
