...
class RdoNodeWrapperFactory {
    ...
    make({ value, key, wrappedParentRdoNode, wrappedSourceNode, matchingNodeOptions, }) {
        ...
        switch (typeInfo.builtInType) {
            ...
            case '[object Number]':
            case '[object String]': {
                return new _1.RdoPrimitiveNW({ value: value, key, wrappedParentRdoNode, wrappedSourceNode, typeInfo, matchingNodeOptions, globalNodeOptions: this._globalNodeOptions });
            }
            case '[object Object]': {
            ...
            case '[object Array]': {
                return new _1.RdoArrayNW({ value: value, typeInfo, key, wrappedParentRdoNode, wrappedSourceNode, syncChildNode: this._syncChildNode, matchingNodeOptions, globalNodeOptions: this._globalNodeOptions });
            }
            case '[object Map]': {
                return new _1.RdoMapNW({ value: value, typeInfo, key, wrappedParentRdoNode, wrappedSourceNode, syncChildNode: this._syncChildNode, matchingNodeOptions, globalNodeOptions: this._globalNodeOptions });
            }
            case '[object Set]': {
                return new _1.RdoSetNW({ value: value, typeInfo, key, wrappedParentRdoNode, wrappedSourceNode, syncChildNode: this._syncChildNode, matchingNodeOptions, globalNodeOptions: this._globalNodeOptions });
            }
            default: {
