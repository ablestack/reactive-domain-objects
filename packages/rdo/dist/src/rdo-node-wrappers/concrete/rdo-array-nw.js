...
class RdoArrayNW extends __1.RdoCollectionNWBase {
    ...
    updateElement(key, value) {
        if (this.childElementCount() === 0)
            return false;
        return collection_utils_1.CollectionUtils.Array.updateElement({ collection: this._value, makeElementKey: this.makeKey, value });
    }
    //------------------------------
    ...
    deleteElement(key) {
        return collection_utils_1.CollectionUtils.Array.deleteElement({ collection: this._value, makeElementKey: this.makeKey, key });
    }
    clearElements() {
