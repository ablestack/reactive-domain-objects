...
// -----------------------------------
export const mockWatchedAllCollectionsQueryResult_Trio: MockWatchedAllCollectionsQueryResult = {
  data: {
...
// ALL COLLECTIONS GRAPH - TEST SOURCE MODEL
// -----------------------------------
export const mockWatchedAllCollectionsQueryResult_Uno: MockWatchedAllCollectionsQueryResult = {
  data: {
    arrayOfNumbers: [1],
